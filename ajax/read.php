    ...
    <div class="todo_card" title="<?= $todo->title; ?>">
        ...
        <div class="card_top">
            ...
            <div class="action_buttons">
                <button class="btn btn_finished <?= ($todo->status == 1) ? "active" : ""; ?>" data-status="<?= $todo->status; ?>" data-id="<?= $todo->id; ?>" title="✔ Finished?">
                ...
                <button class="btn btn_delete" data-id="<?= $todo->id; ?>" title="Delete">
        ...
        <div class="card_bottom" title="<?= date("h:i A | D, d M, Y", strtotime($todo->createdAt)); ?>">
