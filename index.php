        ...
        <div id="todo">
            ...
            <div class="todo_card">
                ...
                <div class="card_center">
                    <h4>Generate Sitemap in WordPress...</h4>
                    <p>Generate sitemap in a wordpress website as soon as possible, hack the google 😅</p>
                </div>

                <!-- Card Bottom: Todo Date -->
                <div class="card_bottom">
                    <p><?= date("h:i, d M, Y", time()); ?></p>
                </div>
            </div>
